...
### Exception Handling
- Custom exceptions: `NotFoundException`, `DuplicateCourseException`
...
- `DuplicateCourseException` → 409 (course POST/PATCH violates unique constraint on `created_by, club, course, city, state`)
